...
engine = create_engine('sqlite:////home/turkai/Masaüstü/workplace/library/ormdatabase2/db/irem4.db')
...
class Log(Base):
    ...
    Library_id=Column(Integer,ForeignKey('library.BookID'),nullable=False)
